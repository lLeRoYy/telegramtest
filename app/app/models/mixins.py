...
class AbstractTelegramUser:
    ...
    user_id = Column(BigInteger, nullable=False, unique=True, index=True, doc="ID пользователя")
    ...
    def referral_url(self) -> str:
        ...
        if not isinstance(settings.bot_link, str) or not isinstance(settings.bot_name, str):
